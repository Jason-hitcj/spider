...
class DoubanSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # items = sel.xpath('/html/body/div[3]/div[1]/div/div[1]/ol/li')
        # for item in items:
        #     movie_item = MovieItem()
        #     movie_item['title'] = item.xpath('//div/div[2]/div[1]/a/span[1]/text()').extract_first()
        #     movie_item['detail'] = item.xpath('//div/div[2]/div[2]/p[1]/text()[1]').extract_first()
        #     yield movie_item
